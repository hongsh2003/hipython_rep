...
url = 'https://apihub.kma.go.kr/api/typ01/cgi-bin/url/nph-aws2_min?stn=0&disp=0&help=1&authKey=HJoNoA_WR0uaDaAP1sdLcw'
...
# URL과 저장 경로 변수를 지정합니다.
req_url = 'https://apihub.kma.go.kr/api/typ01/cgi-bin/url/nph-aws2_min?stn=0&disp=0&help=1&authKey=HJoNoA_WR0uaDaAP1sdLcw'
